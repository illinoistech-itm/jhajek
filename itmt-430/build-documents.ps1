...
pandoc -s -o ./reports/sprint-03/written-report-rubric.pdf -V geometry:margin=.50in ./reports/sprint-03/rubric.md
pandoc -s -o ./reports/sprint-03/written-report-template.pdf -V geometry:margin=.50in ./reports/sprint-03/template.md