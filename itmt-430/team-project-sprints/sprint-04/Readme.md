...
* Deployment
  * All work needs to be tested and developed on your teams built Vagrant Boxes
    * You will have to build often, perhaps daily/nightly
    * We can set up a Timer script to automate this building for you if you are interested
