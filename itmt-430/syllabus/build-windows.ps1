...
If (Test-Path "./output/pdf/itmt-430-spring-2025-Systems-Integration*"){
  Remove-Item ./output/pdf/*.pdf -Verbose
}Else{
  Write-Output "./output/pdf/itmt-430-spring-2025-Systems-Integration.pdf - File does not exist"
}

If (Test-Path "./output/docx/itmt-430-spring-2025-Systems-Integration*"){
  Remove-Item ./output/docx/*.docx -Verbose
}Else{
  Write-Output "./output/docx/itmt-430-spring-2025-Systems-Integration.docx - File does not exist"
}

If (Test-Path "./output/odt/itmt-430-spring-2025-Systems-Integration*"){
  Remove-Item ./output/odt/*.odt -Verbose
}Else{
  Write-Output "./output/odt/itmt-430-spring-2025-Systems-Integration.odt - File does not exist"
}
#######################################################################################################################
# PDF - for e-reader 
...
pandoc -V fontsize=12pt -s -o ./output/docx/itmt-430-spring-2025-Systems-Integration-$STAMP.docx -f markdown -t docx syllabus.md

#####################
# ODT
#####################
pandoc -V fontsize=12pt -s -o ./output/odt/itmt-430-spring-2025-Systems-Integration-$STAMP.odt -f markdown -t odt syllabus.md