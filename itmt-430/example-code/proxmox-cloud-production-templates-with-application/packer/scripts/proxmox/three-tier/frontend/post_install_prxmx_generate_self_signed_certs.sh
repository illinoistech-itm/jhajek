...
sudo openssl req -x509 -nodes -days 365 -newkey rsa:4096 -keyout /home/flaskuser/signed.key -out /home/flaskuser/signed.crt -subj "/C=US/ST=IL/L=Chicago/O=IIT/OU=itm/CN=iit.edu"
