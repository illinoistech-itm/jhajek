...
packer build -parallel-builds=0 -var "mem-build-allocation=2048" -var "headless-val=true" -force ./aom-parallel-deploy-logging.json
packer build -parallel-builds=0 -var "mem-build-allocation=2048" -var "headless-val=true" -force ./aom-parallel-deploy-tornado.json
```
