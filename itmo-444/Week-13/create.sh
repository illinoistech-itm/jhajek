...
aws autoscaling create-launch-configuration --launch-configuration-name jrh-asg-lc --image-id ami-51537029 --iam-instance-profile Name="inclass-project" --instance-type t2.micro --key-name thinkpad --security-groups inclass2018 --user-data file://create-env.sh
