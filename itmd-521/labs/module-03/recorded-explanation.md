...
1) Make sure to introduce yourself and tell us which section you are in (briefly)
1) Are you loading the M&M data set filename through the command line or using the absolute path to the file?
1) What function are you using to read data from a file into a DataFrame?
1) For your results, which state and color has the top 2 highest count?
1) How did you filter data for CA? What is the least count and color of M&M for CA?
