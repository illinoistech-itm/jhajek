...
- Using the Divy bike rental data provided by the professor
...
- In your local Git Repo, create a folder named **assignment-01** under the `itmd-521` folder.  Create a sub-folder named `example-data` and an application named `assignment-01.py`
...
- You will run some Transformations and Actions using the second DataFrame created
...
- Repeat the above steps and create a file named: `assignment-01.scala`
  ...
  - Create any necessary scaffolding
  - build.sbt
...
Due at the **Start of class** February 15th 8:30 am.