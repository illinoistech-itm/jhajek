...
sudo firewall-cmd --zone=metrics-network --change-interface=enx5ce9319c5dd5 --permanent
...
sudo firewall-cmd --zone=meta-network --change-interface=enp2s0 --permanent
...
sudo firewall-cmd --zone=meta-network --change-interface=enx782d7e14ae98 --permanent
##############################################################################################
