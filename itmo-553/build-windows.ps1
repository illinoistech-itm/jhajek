...
If (Test-Path "./output/pdf/itmo-553-fall-2021-cloud-computing-technologies*"){
  ...
  Write-Output "./output/pdf/itmo-553-fall-2021-cloud-computing-technologies.pdf - File does not exist =("
}

If (Test-Path "./output/docx/itmo-553-fall-2021-cloud-computing-technologies*"){
  Remove-Item ./output/docx/*.docx -Verbose
}Else{
  Write-Output "./output/docx/itmo-553-fall-2021-cloud-computing-technologies.docx - File does not exist =("
}

If (Test-Path "./output/odt/itmo-553-fall-2021-cloud-computing-technologies*"){
  Remove-Item ./output/odt/*.odt -Verbose
}Else{
  Write-Output "./output/odt/itmo-553-fall-2021-cloud-computing-technologies.odt - File does not exist =("
}
#######################################################################################################################
# PDF - for e-reader 
