...
If (Test-Path "../../output/pdf/itmo-444-cloud-computing-technologies-*"){
  Remove-Item ../../output/pdf/itmo-444-cloud-computing-technologies-*.pdf -Verbose
}Else{
...
If (Test-Path "../../output/docx/itmo-444-cloud-computing-technologies-*"){
  Remove-Item ../../output/docx/itmo-444-cloud-computing-technologies-*.docx -Verbose
}Else{
...
If (Test-Path "../../output/odt/itmo-444-cloud-computing-technologies-*"){
  Remove-Item ../../output/odt/itmo-444-cloud-computing-technologies-*.odt -Verbose
}Else{
...
########################################################################################################################
pandoc -V geometry:margin=.75in -V paperwidth=6.14in -V paperheight=9.25in -V linkcolor=blue -V fontsize=10pt -V -s -t latex -o ../../output/pdf/itmo-444-cloud-computing-technologies-$STAMP.pdf ./syllabus.md

#############################################################################################################################
# DOCX - [Convert your Markdown file to Word (docx):](http://bob.yexley.net/generate-a-word-document-from-markdown-on-os-x/)#############################################################################################################################
pandoc -V fontsize=10pt -V -s -o ../../output/docx/itmo-444-cloud-computing-technologies-$STAMP.docx -f markdown -t docx .\syllabus.md

#####################
# ODT
#####################
pandoc -V fontsize=10pt -s -o ../../output/odt/itmo-444-cloud-computing-technologies-$STAMP.odt -f markdown -t odt .\syllabus.md
