...
resource "aws_s3_bucket_policy" "allow_access_from_another_account-raw" {
  depends_on=[data.aws_iam_policy_document.data.aws_iam_policy_document.allow_access_from_another_account-raw]
...
resource "aws_s3_bucket_policy" "allow_access_from_another_account-finished" {
  depends_on=[data.aws_iam_policy_document.data.aws_iam_policy_document.allow_access_from_another_account-finished]
