...
print("Begin tests for destroy-env.sh Final Module Assessment for ITMO-444...")
destroyTestResults = []
##############################################################################
...
##############################################################################
print('*' * 79)
print("Testing for the correct number of EC2 instances terminated and not in a RUNNING state...")
try:
...
print("\r")
##############################################################################
# Check to make sure 2 RDS instances have been deleted
##############################################################################
print('*' * 79)
print("Testing for the non-existence of RDS instances...")

if len(responserds['DBInstances']) == 0:
  print("Way to go! No running RDS instances were found...")
  grandtotal +=1
else:
  print("Something happened, and you have: " + str(len(responserds['DBInstances'])) + " RDS instance(s) running.")
...
print("You should now see a destroy-env-module-final-results.txt file has been generated.")
f.close
print('*' * 79)