...
########################################################################################################################
pandoc -V geometry:margin=.75in -V paperwidth=6.14in -V paperheight=9.25in -V linkcolor=blue -V fontsize=10pt -V -s -t latex -o ./output/pdf/itmo-453-fall-2021-cloud-computing-technologies-$STAMP.pdf ./syllabus/syllabus.md
#############################################################################################################################
# DOCX - [Convert your Markdown file to Word (docx):](http://bob.yexley.net/generate-a-word-document-from-markdown-on-os-x/)#############################################################################################################################
pandoc -V fontsize=10pt -s -o ./output/docx/itmo-453-fall-2021-cloud-computing-technologies-$STAMP.docx -f markdown -t docx .\syllabus\syllabus.md

#####################
# ODT
#####################
pandoc -V fontsize=10pt -s -o ./output/odt/itmo-453-fall-2021-cloud-computing-technologies-$STAMP.odt -f markdown -t odt .\syllabus\syllabus.md